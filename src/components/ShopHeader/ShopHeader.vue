  ...
  <div class="shop-header">
    ...
    <transition name="fade">
      <div class="activity-sheet" v-show="supportShow">
        ...
        <div class="activity-sheet-cover" @click.self="toggleSupportShow"></div>
      </div>
    </transition>
  </div>
</template>
...
export default {
  data() {
    return {
      supportClasses: ["activity-blue", "activity-red", "activity-orange"],
      shopShow: false, //商家信息展示
      supportShow: false //优惠活动展示
    };
  },
  computed: {
    ...mapState(["info"])
